...
class ModelMatchFull:
    def __init__(self, arguments):
        ...
        if not os.path.exists("out/modeled_match_in"):
            os.makedirs("out/modeled_match_in")
        self.output_dir = "out/modeled_match_in"
    ...
    def main(self):
        ...
        for split in self.splits:
            ...
            turnout_models.append({
                ...
                "fits": fits,
                "mean_control_matched_registered": len(to_model[
                    (to_model["treatment"] == 0) & (to_model["matched_registered"] == 1)
